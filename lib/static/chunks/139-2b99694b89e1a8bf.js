(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[139], {
		...
		325: function(e, t, r) {
			...
			function o(e, t) {
				return (0, u.normalizePathTrailingSlash)((0, n.addPathPrefix)(e, "/NextJS-Tailwind-App-Presentation-Page"))
		...
		7858: function(e, t, r) {
			...
			function S(e) {
				let {
					...
					notFoundStyles: E,
					asNotFound: S
				} = e, T = (0, u.useMemo)(() => (0, d.createInitialRouterState)({
					children: i,
					initialCanonicalUrl: n,
					initialTree: r,
					...
					canonicalUrl: I,
					nextUrl: N
				}, D, F] = (0, f.useReducerWithReduxDevtools)(a.reducer, T);
				(0, u.useEffect)(() => {
					g = null
				}, []);
				let {
		...
		9544: function(e, t, r) {
			...
			function O(e) {
				...
				if (u && null !== u.current && (_ ? _.status === l.CacheStates.LAZY_INITIALIZED && (_.status = l.CacheStates.READY, _.subTreeData = u.current) : (n.set(d, {
						status: l.CacheStates.READY,
						data: null,
						subTreeData: u.current,
						parallelRoutes: new Map
					}), _ = n.get(d))), !_ || _.status === l.CacheStates.LAZY_INITIALIZED) {
		...
		5580: function(e, t) {
			...
			function o(e, t) {
				let r = Error(u);
				return r.digest = u + ";" + t + ";" + e, r
			}

			function a(e, t) {
				throw void 0 === t && (t = "replace"), o(e, t)
			}
			...
			}(n = r || (r = {})).push = "push", n.replace = "replace", ("function" == typeof t.default || "object" == typeof t.default && null !== t.default) && void 0 === t.default.__esModule && (Object.defineProperty(t.default, "__esModule", {
				value: !0
			}), Object.assign(t.default, t), e.exports = t.default)
		},
		99: function(e, t, r) {
			...
			Object.defineProperty(t, "__esModule", {
				...
				get: function() {
					return function e(t, r, o) {
						...
						let d = 2 === t.length;
						if (d) a = u(i[s], o);
						else if (null === (a = e(t.slice(2), i[s], o))) return null;
						let p = [t[0], {
							...i,
							[s]: a
						}];
			...
			Object.defineProperty(t, "__esModule", {
				...
				get: function() {
					return function e(t, r, u) {
						let o;
						let [a, l, i, c, f] = r || [null, {}], s = t[0], d = 1 === t.length, p = null !== a && (0, n.matchSegment)(a, s), h = Object.keys(l).length > 1, y = !r || !p || h, _ = {};
						if (null !== a && p && (_ = l), !d && !h) {
						...
						return i && (b[2] = i), !u && y ? b[3] = "refetch" : p && c && (b[3] = c), p && f && (b[4] = f), b
					}
				}
			});
			let n = r(7450);
			...
			async function i(e, t, r, i) {
				...
				try {
					...
					let r = await fetch(t, {
						...
						f = i === u.RSC_CONTENT_TYPE_HEADER;
					if (f || (f = i.startsWith("text/plain")), !f) return [r.url, void 0];
					let s = await (0, n.createFromFetch)(Promise.resolve(r), {
				...
				get: function() {
					return function e(t, r, l, i) {
						...
						if (c) {
							...
							}, y && (0, u.invalidateCacheByRouterState)(_, y, l[2]), (0, o.fillLazyItemsTillLeafWithHead)(_, y, l[2], l[4], i), h.set(d, _));
							return
						}
						_ && y && (_ === y && (_ = {
							status: _.status,
						...
						for (let i in o[1]) {
							...
							if (r) {
								...
								if (u) {
									...
									r.set(s, f), e(f, o, c, a, l), t.parallelRoutes.set(i, r);
									continue
								}
							}
							let d = {
			...
			Object.defineProperty(t, "__esModule", {
				...
				get: function() {
					return function e(t, r, u) {
						...
						if (f && f !== c || (f = new Map(c), t.parallelRoutes.set(a, f)), o) {
							f.delete(i);
							return
						}
						let s = c.get(i),
		...
		566: function(e, t, r) {
			...
			function O(e, t) {
				...
				if (j && (null == A ? void 0 : A.kind) !== h.PrefetchKind.TEMPORARY) {
					...
					let s = (0, o.createRecordFromThenable)((0, u.fetchServerResponse)(r, a, e.nextUrl)),
						d = t.slice(1).map(e => ["children", e]).flat(),
						p = (0, c.fillCacheWithDataProperty)(i, e.cache, d, () => s, !0);
					if (!(null == p ? void 0 : p.bailOptimistic)) return R.previousTree = e.tree, R.patchedTree = a, R.pendingPush = w, R.hashFragment = T, R.scrollableSegments = [], R.cache = i, R.canonicalUrl = M, e.prefetchCache.set((0, l.createHrefFromUrl)(r, !1), {
				...
				for (let t of D) {
					let o = t.slice(0, -4),
						[a] = t.slice(-3),
						l = (0, s.applyRouterStatePatchToTree)(["", ...o], k, a);
					if (null === l && (l = (0, s.applyRouterStatePatchToTree)(["", ...o], I, a)), null !== l) {
						if ((0, p.isNavigatingToNewRootLayout)(k, l)) return m(e, R, M, w);
						let f = (0, _.applyFlightData)(L, E, t, "auto" === A.kind && x === b.PrefetchCacheEntryStatus.reusable);
						...
						let s = (0, d.shouldHardNavigate)(["", ...o], k);
						for (let e of (s ? (E.status = n.CacheStates.READY, E.subTreeData = L.subTreeData, (0, i.invalidateCacheBelowFlightSegmentPath)(E, L, o), R.cache = E) : f && (R.cache = E), L = E, k = l, g(a))) {
							let t = [...o, ...e];
							"__DEFAULT__" !== t[t.length - 1] && U.push(t)
						}
					}
				}
				return R.previousTree = e.tree, R.patchedTree = k, R.scrollableSegments = U, R.canonicalUrl = F ? (0, l.createHrefFromUrl)(F) : M, R.pendingPush = w, R.hashFragment = T, (0, y.handleMutable)(e, R)
			}("function" == typeof t.default || "object" == typeof t.default && null !== t.default) && void 0 === t.default.__esModule && (Object.defineProperty(t.default, "__esModule", {
				value: !0
			}), Object.assign(t.default, t), e.exports = t.default)
		},
		8478: function(e, t, r) {
			...
			function i(e, t) {
				...
				let f = (0, a.createRecordFromThenable)((0, u.fetchServerResponse)(r, e.tree, e.nextUrl, t.kind));
		...
		8777: function(e, t, r) {
			...
			function p(e, t) {
				let {
					...
					mutable: p,
					origin: h
				} = t, y = e.canonicalUrl, _ = JSON.stringify(p.previousTree) === JSON.stringify(e.tree);
				...
				for (let t of b) {
					...
					v && (p.canonicalUrl = o);
					let [f, h] = t.slice(-2);
					null !== f && (r.status = s.CacheStates.READY, r.subTreeData = f, (0, d.fillLazyItemsTillLeafWithHead)(r, void 0, n, h), p.cache = r, p.prefetchCache = new Map), p.previousTree = m, p.patchedTree = u, p.canonicalUrl = y, m = u
				}
		...
		4449: function(e, t, r) {
			...
			async function d(e, t) {
				let {
					actionId: r,
					actionArgs: o
				} = t, a = await (0, l.encodeReply)(o), i = await fetch("", {
					method: "POST",
					headers: {
					...
					body: a
				}), f = i.headers.get("location"), s = f ? new URL((0, c.addBasePath)(f), window.location.origin) : void 0;
			...
			function p(e, t) {
				...
				t.mutable.inFlightServerAction || (t.mutable.previousTree = e.tree, t.mutable.inFlightServerAction = (0, o.createRecordFromThenable)(d(e, t)));
				let {
					actionResult: r,
					actionFlightData: n,
					redirectLocation: u
				...
				if (u) {
					if (n) {
						let r = (0, f.createHrefFromUrl)(u, !1);
						e.prefetchCache.set(r, {
							data: (0, o.createRecordFromThenable)(Promise.resolve([n, void 0])),
					...
					t.reject((0, s.getRedirectError)(u.toString(), s.RedirectType.push))
				} else n && setTimeout(() => {
		...
		2672: function(e, t, r) {
					...
					return "string" == typeof r ? function(e, t, r, n) {
						if ("$" === n[0]) {
							...
							switch (n[1]) {
								...
								case "L":
									return {
										$$typeof: s, _payload: e = A(e, t = parseInt(n.slice(2), 16)), _init: O
									};
								case "@":
			...
			t.createFromFetch = function(e, t) {
				...
				return r.$$FORM_ACTION = v, y.set(r, {
					id: e,
					bound: null
				}), r
				...
				return ! function e(t, u, o, a, l) {
					...
					if (d = 0, a = "" === a ? "." : a + ":", E(t))
						for (var p = 0; p < t.length; p++) {
							...
							for (t = h.call(t), p = 0; !(s = t.next()).done;) h = a + C(s = s.value, p++), d += e(s, u, o, h, l);
		...
		4248: function(e, t) {
			...
			t.unstable_IdlePriority = 5, t.unstable_ImmediatePriority = 1, t.unstable_LowPriority = 4, t.unstable_NormalPriority = 3, t.unstable_Profiling = null, t.unstable_UserBlockingPriority = 2, t.unstable_cancelCallback = function(e) {
				...
				return l = o + l, e = {
					...
					expirationTime: l,
					sortIndex: -1
				}, o > a ? (e.sortIndex = o, r(s, e), null === n(f) && e === n(s) && (b ? (m(S), S = -1) : b = !0, N(P, o - a))) : (e.sortIndex = l, r(f, e), _ || y || (_ = !0, I(E))), e
